...
function displayhelp {
        ...
        where :
         ...
         --ipconfig: shows report about the IP addresses
         --os: display report about the OS
         --cpu: generate report about the host
         --memory: display report about system memory
         --disk: shows report only about the system disk space utilization
         --printer: generate report about the printers attached to the system
         "
}
